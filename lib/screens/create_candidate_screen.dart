...
class CreateCandidateScreen extends StatefulWidget {
  ...
  @override
  State<CreateCandidateScreen> createState() => _MyHomeScreenState();
}

class _MyHomeScreenState extends State<CreateCandidateScreen> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      final newCandidate = Candidate(
        ...
        graduationYear: _selectedDate?.year ?? DateTime.now().year,
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Seção: Características Pessoais
              _skillsCard(
  ...
  Widget _buildField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: label,
        labelStyle: const TextStyle(fontSize: 14, color: Color(0xFF718096)),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Icon(Icons.close, size: 14, color: tagTextColor),
                      ),
                    ],
                  ),
                );
